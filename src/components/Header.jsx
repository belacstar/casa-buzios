        ...
        >
            <div className="max-w-7xl mx-auto px-6 py-2 flex justify-between items-center relative">
                ...
                <button
                    ...
                    className="md:hidden text-primary focus:outline-none z-50 transition-transform duration-300 ease-in-out transform bg-white/70 backdrop-blur-sm p-1 rounded-md shadow-md"
                >
                    {isMobileMenuOpen ? (
                ...
                {/* Navegação Desktop */}
                <nav className="hidden md:flex space-x-6 font-semibold text-white drop-shadow-[0_1px_3px_rgba(0,0,0,0.6)] tracking-wide">
                    <a href="#galeria" className="hover:text-secondary transition duration-300">GALERIA</a>
                    <a href="#casa" className="hover:text-secondary transition duration-300">A CASA</a>
                    <a href="#reserva" className="hover:text-secondary transition duration-300">RESERVAR</a>
                </nav>
            ...
            <div
                ...
                `}
            >
                <div className="px-6 pb-4 pt-3 space-y-3 text-primary font-semibold text-base bg-white/40 backdrop-blur-lg shadow-md rounded-b-xl transition-opacity duration-500">
                    <a href="#galeria" className="block hover:text-secondary transition">GALERIA</a>
                    <a href="#casa" className="block hover:text-secondary transition">A CASA</a>
                    <a href="#reserva" className="block hover:text-secondary transition">RESERVAR</a>
                </div>
            </div>
        </header>
    );
